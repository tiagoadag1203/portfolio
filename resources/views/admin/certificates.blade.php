    ...
    <ul>
        ...
        <li>
            <x-list-item :item="$certificate" type="certificate">
                ...
                <!-- MODAL EXCLUSÃO -->
                <x-modal id="modalDeletecertificate{{ $certificate->id }}" title="Deletar {{ $certificate->name }}">
