...
@section('conteudo')
<x-alert></x-alert>
<main class="main flex column centered">
    <div class="flex column centered container-login gap-20">
        <h2>Login</h2>
        <form class="flex column centered gap-20 form-login" method="POST" action="/login">
            @csrf
